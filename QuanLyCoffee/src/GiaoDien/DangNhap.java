...
import static GiaoDien.DangNhap.nv;
import dao.UserDAO;
...
public class DangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Đăng Nhập Quản Lý Của Hàng");
        setUndecorated(true);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/coffee1.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Button-stop-icon.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Boolean b = new UserDAO().checkUser(User, Pass);
        ...
        if (User.length() == 0 && Pass.length() == 0) {
            ...
            if (b) {
                TrangChu objTT = new TrangChu();
                objTT.setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "Mật khẩu hoặc tài khoản đăng nhập không đúng");
            }
        }
